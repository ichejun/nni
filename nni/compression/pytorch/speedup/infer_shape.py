...
infer_from_inshape = {
    ...
    'Upsample': lambda module_masks, mask: maxpool2d_inshape(module_masks, mask),
    ...
    'Concat': lambda module_mask, mask, cat_info, last_visited: cat_inshape(module_mask, mask, cat_info, last_visited),
